...
class jobDescription(BaseModel):
    ...
    preffered_skills:list[str]=Field(default_factory=list,description='Preferred qualifications or skills')
    minimum_experience:float|None=Field(default=None,description='Minimum experience in years required, or null if not specified')
    responsibilites:list[str]=Field(default_factory=list,description='Core responsibilities and duties')
...
class Resume(BaseModel):
    ...
    total_experience_years: float | None =Field(None,description='Experience of the Candidate in years')
    skills: list[str] | None =Field(default_factory=[],description='General skills listed or extracted from the resume"')
    experience: list[Experience] | None = Field(default_factory=list, description="Work and internship history")
    education: list[Education] | None = Field(default_factory=list, description="Educational qualifications")
    projects: list[str] | None = Field(default_factory=list, description="Key projects completed")
